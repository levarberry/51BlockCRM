...
<div class="container">
    <div class="section">
        ...
        <div class="form-group row">
            ...
            <label for="agency_name" class="col-lg-4 col-form-label">Agency:</label>

            <div class="col-lg-6" >
                <input type="text" class="form-control"  name="agency_name" placeholder="Insert Agency Name">
            </div>
            <div class="col-lg-2">
    ...
    <div class="section row">
        ...
        <div class="col-ms-12 hdr"> Agency Name</div>
    </div>
    <!-- Now we're looping -->
    <div class="section">
    <?php
            ...
            <div class='lst row'>
                ...
                <div class="col-md-8  col-xs-4">
                  <form method="POST">
                      ...
                      <input type="hidden" name="agency_id" value="<?=$obj->agency_id?>">
                     <button type="button" class="btn btn-primary" onClick="edititm(this.form, '<?=$obj->agency_name?>' , '<?=$obj->agency_id?>' )"><i class="fa fa-edit"></i></button>
                
                      <button type="button"  class="btn btn-danger" onClick="removeitm(this.form, '<?=$obj->agency_name?>')"><i class="fa fa-trash"></i></button>
                    </form>
                </div>
            </div>
          <?php
...
<div id="editbox"  class="modal">
    ...
    <div class="modal-content" >
       <form method="POST">
           ...
           <input type="hidden" name="agency_id" id="edt_id">
        <div class="form-group">
            <label for="edt_nm">Edit Name:</label>
            <div class="form-control">
                <input type="text" class="form-control" name="agency_name" id="edt_nm">
            </div>
...
<?php
    function agency_add($con)
    {
        ...
        $ins = "insert into agencies(agency_name) values('" . $_POST['agency_name'] . "')";
        
        $con->query($ins);
    }

    function agency_delete($con) {
        $rm = "delete from agencies where agency_id=" . $_POST['agency_id'];
        $con->query($rm);
...
<script>
    function removeitm(frm,nm) {
        ...
        var bcheck = confirm("Delete this agency: " + nm);
